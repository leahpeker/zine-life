...
function ht() {
	...
	let h = dt();
	o.isSupported =
		typeof Tt == 'function' && typeof ee == 'function' && me && me.createHTMLDocument !== void 0;
	const {
		MUSTACHE_EXPR: pe,
		ERB_EXPR: de,
		TMPLIT_EXPR: Te,
		...
		ye = function () {
			...
			if (!(H && H === e)) {
				if (
					((!e || typeof e != 'object') && (e = {}),
					(e = C(e)),
					(j = Ft.indexOf(e.PARSER_MEDIA_TYPE) === -1 ? Ht : e.PARSER_MEDIA_TYPE),
					(p = j === 'application/xhtml+xml' ? Ne : fe),
					(m = L(e, 'ALLOWED_TAGS') ? a({}, e.ALLOWED_TAGS, p) : Ue),
					(d = L(e, 'ALLOWED_ATTR') ? a({}, e.ALLOWED_ATTR, p) : Fe),
					(Oe = L(e, 'ALLOWED_NAMESPACES') ? a({}, e.ALLOWED_NAMESPACES, Ne) : kt),
					(Se = L(e, 'ADD_URI_SAFE_ATTR') ? a(C(Ve), e.ADD_URI_SAFE_ATTR, p) : Ve),
					(Xe = L(e, 'ADD_DATA_URI_TAGS') ? a(C(je), e.ADD_DATA_URI_TAGS, p) : je),
					...
					e.FORBID_CONTENTS && (U === Ye && (U = C(U)), a(U, e.FORBID_CONTENTS, p)),
					Ae && (m['#text'] = !0),
					...
					: e.namespaceURI === ie
						? t.namespaceURI === b
							...
							: t.namespaceURI === ae
								...
								: !!Ke[n]
						: e.namespaceURI === b
							? (t.namespaceURI === ae && !se[c]) || (t.namespaceURI === ie && !re[c])
								? !1
								: !Ke[n] && (Ut[n] || !qe[n])
	...
	const et = function (e) {
			...
			return (e instanceof Pe && !Gt(e)) ||
				...
				: (P &&
						...
						e.textContent !== t && ($(o.removed, { element: e.cloneNode() }), (e.textContent = t))),
		...
		(o.sanitize = function (i) {
			...
			if ((ge || ye(e), (o.removed = []), typeof i == 'string' && (X = !1), X)) {
				...
				(t = Ze('<!---->')),
					...
					(n.nodeType === J.element && n.nodeName === 'BODY') || n.nodeName === 'HTML'
						? (t = n)
						: t.appendChild(n);
			else {
				if (!v && !P && !w && i.indexOf('<') === -1) return g && oe ? g.createHTML(i) : i;
